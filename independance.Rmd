...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
kable(head(df), "html") %>% kable_styling("striped", font_size = taille) %>% scroll_box(width = "100%")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
kable(head(df), "html") %>% kable_styling("striped", font_size = taille) %>% scroll_box(width = "100%", height = "200px")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
kable(chisq_table, "html", row.names = TRUE) %>% kable_styling("striped", font_size = taille) %>% scroll_box(width = "100%")
```
