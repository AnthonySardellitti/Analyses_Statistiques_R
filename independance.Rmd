...
On effectue une analyse de variance pour mesurer l'indépendance entre une variable qualitative et une quantitative. La pertinence de ce test repose sur les hypothèses d'indépendance de chaque groupe ainsi que l'égalité des variances que l'on peut verifier avec un test de Bartlett. C'est avec un test de Fisher qu'on peut ensuite réaliser l'ANOVA.
