...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
kable(head(df), "html") %>% kable_styling("striped", font_size = taille) %>% scroll_box(width = "100%", height = "100px")
```
...
kable(df_cor, "html") %>% kable_styling("striped", font_size = taille) %>% scroll_box(width = "100%", height = "400px")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
kable(head(df), "html") %>% kable_styling("striped", font_size = taille) %>% scroll_box(width = "100%", height = "400px")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
kable(chisq_table, "html", row.names = TRUE) %>% kable_styling("striped", font_size = taille) %>% scroll_box(width = "100%", height = "200px")
```
...
```{r}
df <- read.csv(file = "./datasets/Hotdogs.csv", 
               sep = ";")
```

```{r, echo=FALSE, warning=FALSE, message=FALSE}
kable(df, "html") %>% kable_styling("striped", font_size = taille) %>% scroll_box(width = "100%", height = "400px")
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
kable(df, "html") %>% kable_styling("striped", font_size = taille) %>% scroll_box(width = "40%", height = "200px")
```
